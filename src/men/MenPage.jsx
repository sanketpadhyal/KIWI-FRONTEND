...
const isMenProduct = (gender) => {
  const normalizedGender = normalizeValue(gender)
  return ["male", "men", "both", "all", "unisex"].includes(normalizedGender)
}

const isMenCategoryProduct = (category) => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const data = querySnapshot.docs
          ...
          .filter((item) => isMenProduct(item.gender) && isMenCategoryProduct(item.category))
      ...
      <section className="products-container new-arrivals-section">
        <div className="new-arrivals-shell">
          ...
          <div className="products-header">
            <div>
              <span className="products-eyebrow">Menswear Edit</span>
              <h1 className="title">Men</h1>
              <p className="products-tagline">
                Explore men&apos;s clothing and shoes from the Kiwi catalog in one clean curated page.
              </p>
            </div>
                  ...
                  <div className="product-card" key={item.id}>
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-meta">
                        <span className="product-meta-note">Men&apos;s pick</span>
                      </div>
