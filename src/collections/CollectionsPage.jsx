...
const isCollectionCategory = (category) => {
  ...
  return ["tech", "accessories"].includes(normalizedCategory)
}
    ...
    const fetchProducts = async () => {
      try {
        ...
        const data = querySnapshot.docs
          ...
          .filter((item) => isCollectionCategory(item.category))
      ...
      <section className="products-container new-arrivals-section">
        <div className="new-arrivals-shell">
          ...
          <div className="products-header">
            <div>
              <span className="products-eyebrow">Tech Collection</span>
              <h1 className="title">Collections</h1>
              <p className="products-tagline">
                Explore Kiwi collection picks in one place, including tech products, accessories, and smart everyday essentials.
              </p>
            </div>
                  ...
                  <div className="product-card" key={item.id}>
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-meta">
                        <span className="product-meta-note">Collection pick</span>
                      </div>
