      ...
      <section className="products-container new-arrivals-section">
        <div className="new-arrivals-shell">
          ...
          <div className="products-header">
            <div>
              <span className="products-eyebrow">Fresh Product Drop</span>
              <h1 className="title">New Arrivals</h1>
              <p className="products-tagline">
                Explore the full Kiwi collection in one place with every product from our latest demo catalog.
              </p>
            </div>

            <div className="products-badge">
              <ShieldCheck size={15} />
              <span>All products visible</span>
            </div>
          </div>
                  ...
                  <div className="product-card" key={item.id}>
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-meta">
                        <span className="product-meta-note">New arrival</span>
                      </div>
