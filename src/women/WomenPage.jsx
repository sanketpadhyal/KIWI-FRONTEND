...
const isWomenProduct = (gender) => {
  const normalizedGender = normalizeValue(gender)
  return ["female", "women", "both", "all", "unisex"].includes(normalizedGender)
}

const isWomenCategoryProduct = (category) => {
  const normalizedCategory = normalizeValue(category)
  return ["clothing", "shoes"].includes(normalizedCategory)
}
    ...
    const fetchProducts = async () => {
      try {
        ...
        const data = querySnapshot.docs
          ...
          .filter((item) => isWomenProduct(item.gender) && isWomenCategoryProduct(item.category))
      ...
      <section className="products-container new-arrivals-section">
        <div className="new-arrivals-shell">
          ...
          <div className="products-header">
            <div>
              <span className="products-eyebrow">Womenswear Edit</span>
              <h1 className="title">Women</h1>
              <p className="products-tagline">
                Explore women&apos;s clothing and shoes from the Kiwi catalog in one clean curated page.
              </p>
            </div>
                  ...
                  <div className="product-card" key={item.id}>
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-meta">
                        <span className="product-meta-note">Women&apos;s pick</span>
                      </div>
